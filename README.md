...
新增qBittorrent 4.1.5的支持，可以自定义软件源如下（试了试似乎可以）：  
src/gz qbittorrent https://github.com/jsp1256/qBittorrent_cross_complie/tree/master/ipk-4.1.5  
注意，需要安装wget和ca-certificates方能正确下载  
